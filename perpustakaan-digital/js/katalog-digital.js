/* =============================================================
   katalog-digital.js — Pojok Baca Tlogosari
   Halaman katalog e-book (online: true)
   ============================================================= */
'use strict';
...
function buildCard(book, globalIdx) {
  ...
  onlineBadge.className = 'card-online-badge';
  onlineBadge.textContent = '📖 Baca Online';
...
async function init() {
  try {
    ...
    allBooks = merged.filter(b => b.online);
